...
RSpec.describe Balance, type: :model do
  ...
  let(:transaction_top_up) { FactoryBot.build(:transaction, income_amount: 1000, type: 'top_up', user_id: user.id) }
  ...
  describe "Methods" do
    describe "#amount" do
      ...
      it "return amount correctly after buy and sell" do
        ...
        transaction_sell = FactoryBot.build(:transaction, income_amount: 20, type: 'sell', asset_type: 'gold', user_id: user.id)
